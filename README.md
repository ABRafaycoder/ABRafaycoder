...
class AbdulRafayRizwan extends MERNDeveloper {
  constructor() {
    ...
    this.status    = "🟢 Available for freelance & collabs";
  }
  ...
  philosophy() {
    return "Ship clean. Ship fast. Ship real.";
  }
}

const rafay = new AbdulRafayRizwan();
...
<img src="https://skillicons.dev/icons?i=mongodb,express,react,nodejs&theme=dark&perline=4" height="90"/>
...
<!--
========================================
 🐍 SNAKE ANIMATION SETUP (adds a live animated contribution snake)
========================================
...
3. Commit it, run the workflow once manually (Actions tab → Generate Snake → Run workflow), 
   and the snake will animate automatically every 6 hours.
========================================
-->
